...
-- -----------------------------------------------------
-- Table `proyecto`.`miembro`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proyecto`.`miembro` (
  `planilla_id_planilla` VARCHAR(45) NOT NULL,
  `estudiante_cta` VARCHAR(45) NOT NULL,
  INDEX `fk_miembro_planilla_idx` (`planilla_id_planilla` ASC) VISIBLE,
  INDEX `fk_miembro_estudiante1_idx` (`estudiante_cta` ASC) VISIBLE,
  CONSTRAINT `fk_miembro_estudiante1`
    FOREIGN KEY (`estudiante_cta`)
    REFERENCES `proyecto`.`estudiante` (`cta`),
  CONSTRAINT `fk_miembro_planilla`
